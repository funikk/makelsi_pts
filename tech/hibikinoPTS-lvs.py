...
# Additional Metals
VIA2 = geomGetShapes("VIA", "drawing")
ML3 = geomGetShapes("ML2", "drawing")

# Device recognition layers
LVSRES0 = geomGetShapes("LVSRES0", "drawing")
LVSCAP0 = geomGetShapes("LVSCAP0", "drawing")
...
resp      = geomAnd(geomAndNot(POL, gate), LVSRES0)
...
extractMOS("mn", ngate, POL, ndiff, PWL)
extractMOS("mp", pgate, POL, pdiff, NWL)
...
#if geomNumShapes(resp) > 0 :
#    print "# Extract poly resistors"
#    extractRes("rp", resp, POL)
